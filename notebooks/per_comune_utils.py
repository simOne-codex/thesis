...
def loader(a, b, c, d, e):
    istruzione = gpd.read_file(data_folder + f'gathering_geojson/per_comune/ISTRUZIONE/{a}.geojson')
    occupazione = gpd.read_file(data_folder + f'gathering_geojson/per_comune/OCCUPAZIONE/{b}.geojson')
    ifc = gpd.read_file(data_folder + f'gathering_geojson/per_comune/IFC/{c}.geojson')
    popolazione = gpd.read_file(data_folder + f'gathering_geojson/per_comune/popolazione/{d}.geojson')
    redditi = gpd.read_file(data_folder + f'gathering_geojson/per_comune/redditi/{e}.geojson')
...
def yearly_data_processing(year, a, b, c, d, e):
    agricensus = gpd.read_file(data_folder+'gathering_geojson/per_comune/agricensus/2020.geojson')
    ...
    save_clean_data(gdf, f'per_comune_{year}_provvisorio', data_folder+'gathering_geojson/per_comune')
