...
pd.DataFrame(gs_r.cv_results_).to_csv('/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/outputs/sample_b/model_fine_tuning.csv', index=False)
####
...
pd.DataFrame(gs_r.cv_results_).to_csv('/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/outputs/sample_b/model_classification_fine_tuning.csv', index=False)
####
