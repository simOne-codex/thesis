...
for m, model in tqdm(enumerate([regression_forest, classification_forest])):
    ...
    results_rfe.to_csv(f'/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/outputs/sample_a/{string2}_rf_rfe.csv')
    rfe_tracking.to_csv(f'/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/outputs/sample_a/{string2}_rf_rfe_tracking.csv')
