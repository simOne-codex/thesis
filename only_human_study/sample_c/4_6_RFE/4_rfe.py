...
X_train_val = pd.read_csv('/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/database/sample_c/X_train_val.csv')
y_train_val = pd.read_csv('/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/database/sample_c/y_train_val.csv')
...
for m, model in tqdm(enumerate([regression_forest, classification_forest])):
    ...
    results_rfe.to_csv(f'/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/outputs/sample_c/{string2}_rf_rfe.csv')
    rfe_tracking.to_csv(f'/nfs/home/genovese/thesis-wildfire-genovese/only_human_study/outputs/sample_c/{string2}_rf_rfe_tracking.csv')
