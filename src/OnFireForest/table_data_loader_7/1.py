...
if not os.path.exists('/nfs/home/genovese/thesis-wildfire-genovese/database/model_input/ambiguous_table_data_input.csv'):
    raise('Not existing output csv')
...
for f in tqdm(fires.index[1200:1280]):
    row = fires.loc[f, :]
